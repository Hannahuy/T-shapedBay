<template>
  ...
  <div class="rightbottombox" v-if="showslice">
    ...
    <div class="rightbottombox-content" v-if="selectedButton === '十字切片'">
      <div>
        <div class="rightbottombox-content-title2">CROSS POSITION</div>
...
let layerFunction = [
  ...
  },
  {
    name: "铵盐",
    check: false,
    image: new URL("../../assets/img/叶绿素.png", import.meta.url).href,
    imageActive: new URL("../../assets/img/叶绿素-active.png", import.meta.url).href,
  },
  {
    name: "磷酸盐",
    check: false,
    image: new URL("../../assets/img/初级生产力.png", import.meta.url).href,
    imageActive: new URL("../../assets/img/初级生产力-active.png", import.meta.url).href,
  },
  {
    name: "硅酸盐",
    check: false,
    image: new URL("../../assets/img/无机磷.png", import.meta.url).href,
  ...
  },
  {
    name: "流速",
    check: false,
    image: new URL("../../assets/img/流速.png", import.meta.url).href,
    imageActive: new URL("../../assets/img/流速-active.png", import.meta.url).href,
  },
];
...
const updatePointPosition = () => {
  if (
    pointPosition.value.x !== lastPrintedPosition.x ||
    pointPosition.value.y !== lastPrintedPosition.y
  ) {
    callUIInteraction({
      ModuleName: `生态动力`,
      FunctionName: `空间分析`,
